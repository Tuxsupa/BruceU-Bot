...
async def addRows(matchID):
    ...
    for i in TELEMETRY_DATA:
        if i["_T"] == "LogPlayerKillV2" and i["victim"]["name"] == "Forsenlol":
    ...
    for i in TELEMETRY_DATA:
        if i["_T"] == "LogPlayerKillV2" and (forsenDied is False or i["attackId"] == attackId):
        ...
        if i["_T"] == "LogPlayerTakeDamage" and (forsenDied is False or i["attackId"] == attackId) and i["victim"]["name"] == "Forsenlol":
            attacker = i["attacker"]
